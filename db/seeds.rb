...
Album.create(title: "Elena's Wedding", description: 'Wonderful memories for a radiant bride', date: Date.new(2019, 9, 7), photographer_id: 1, client_id: 2)
...
Album.create(title: 'Bailey in Autumn', description: 'A happy Corgi among the Autumn foliage', date: Date.new(2021, 1, 15), photographer_id: 2, client_id: 3)
...
Album.create(title: 'Bailey at Christmas', description: 'A Corgi among white Christmas lights', date: Date.new(2020, 12, 25), photographer_id: 2, client_id: 3)
